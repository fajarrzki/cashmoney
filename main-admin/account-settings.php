...
<head>
    ...
    <title>ShoesCare Admin - Account Settings</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-md-10 col-xs-12 col-sm-12" style="background-color: white;padding:20px;">
                            ...
                            <form action="" method="POST">
                                <center><span>Pengaturan Akun</span></center>
                                <hr>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <button type="submit" class="btn btn-primary btn-block text-light" name="registeruser">Perbarui Password</button>
                                    </div>
                                </div>
                                <?php
