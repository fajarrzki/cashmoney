                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-md-10 col-xs-12 col-sm-12" style="background-color: white;padding:20px;">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Biaya Layanan</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Deskripsi Layanan</label>
                                    <div class="col-sm-10">
                                ...
                                <input type="submit" class="btn btn-primary" name="registerdestination" value="Simpan Data">
