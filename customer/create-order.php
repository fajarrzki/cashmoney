                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-md-10 col-xs-12 col-sm-12" style="background-color: white;padding:20px;">
                            ...
                            <form action="" method="POST">
                                <center><span>Tambah Pemesanan</span></center>
                                <hr>
                                <?php
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="selected_Item" id="" class="form-control">
                                            <option value="">klik untuk memilih Paket..</option>
                                            <?php
                                            ...
                                            while ($fetch = mysqli_fetch_assoc($query)) {
                                                ...
                                                echo "<option value='$id'>" . $desc . " for Rp. " . $cost . "</option>";
                                            }
                                            ?>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Hari Pengambilan</label>
                                    <div class="col-sm-10">
                                        <select name="week_day" id="" class="form-control">
                                            <option value="">klik untuk memilih hari..</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <button type="submit" class="btn btn-warning btn-block text-light" name="registeruser">Pesan</button>
                                    </div>
                                </div>
                                <?php
