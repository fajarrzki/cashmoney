                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-md-10 col-xs-12 col-sm-12" style="background-color: white;padding:20px;">
                            ...
                            <form action="" method="POST">
                                <center><span>Pembayaran melalui VA-BCA <?php echo $orderref; ?> dengan Total Biaya Rp.<?php echo $totalcost; ?></span></center>
                                <hr>
                                <?php
                                echo $msg;
                                ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <button type="submit" class="btn btn-primary btn-block text-light" name="registeruser">Konfirmasi Pembayaran</button>
                                    </div>
                                </div>
                                <?php
