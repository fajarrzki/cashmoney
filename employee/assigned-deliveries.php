            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Kurir yang ditugaskan</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <small>
                                <p class="text-danger"> Tandai pesanan sebagai selesai hanya setelah Anda telah mengirimkannya kepada pelanggan.</p>
                            </small>
                                        ...
                                        while ($fetch = mysqli_fetch_assoc($query)) {
                                            ...
                                            echo "
                                                ...
                                                <td>$itemcomments</td>  
                                                 ...
                                                 <td>$transitstatus</td>
                                                 <td><a href='mark-delivered.php?id=$deliveryorderid' class='btn btn-danger btn-block'>Tandai Terkirim</td>
                                            </tr>
                                                ";
                                        }
