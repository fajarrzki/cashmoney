            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Pesanan yang telah Dikirim</h1>
                        <a href="index.php" class="d-none d-sm-inline-block btn btn-sm btn-warning shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Delivered Orders</a>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <small>
                                <p class="text-danger"> Pesanan yang telah Dikirim</p>
                            </small>
